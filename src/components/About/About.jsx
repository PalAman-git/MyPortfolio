...
const About = () => {
  ...
  return (
    <div ref={about} className="about select-none relative h-[100vh] overflow-hidden">
      {/* for creating the loading animation */}
      ...
      <div className="about-container px-[20vw] font-roboto w-full h-full flex flex-col">
        <h1 className="badaKrdo about-title font-bebas mt-20 mb-5">ABOUT ME</h1>
        ...
        <div className="about-buttons-container relative font-bebas font-bold mt-[5rem] flex items-center gap-5">
